...
export const Pricing = ({ handlePro }: { handlePro: () => void }): ReactElement => {
  ...
  return (
    <div className='relative w-full h-[800px] lg:px-10 py-12'>
      ...
      <div className="flex max-lg:flex-col justify-between">
        ...
        <div className="flex items-center gap-x-5">
          <p className='font-light text-[0.8rem] min-[400px]:text-[1rem] text-[#40403e]'>Billed monthly</p>
          <Switch clicked={clicked} handleClick={handleClick} />
          <p className={`font-light text-[0.8rem] min-[400px]:text-[1rem] ${clicked ? 'text-indigo-500' : 'text-[]#40403e'} transition-color duration-300`}>Billed anually</p>
        </div>
      </div>
      {/* body */}
      <div className="grid grid-cols-1 lg:grid-cols-7 max-lg:gap-y-10 max-lg:mt-10 h-full">
        <div className="col-span-2 flex items-center lg:py-5">
          <div className="w-full lg:h-3/4 rounded-[15px]">
        ...
        <div className="col-span-3 flex items-center lg:py-5 lg:px-7">
        ...
        <div className="col-span-2 flex items-center lg:py-5">
          <div className="w-full lg:h-3/4 border border-[#40403e] rounded-[15px] max-lg:mb-10">
